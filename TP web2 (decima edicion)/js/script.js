...
if (document.querySelector(".nombre-alumno") != null){
    document.querySelector(".nombre-alumno").innerHTML = nombre;
}

if (document.querySelector("#max") != null){
    document.querySelector("#max").innerHTML = maximo_preguntas_por_jugada;
}

if (document.querySelector("#min") != null){
    document.querySelector("#min").innerHTML = puntos_resultado_bien;
}